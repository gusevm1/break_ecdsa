...
class ECDSA2():
    ...
    def Sign_FixedNonce(self, nonce: IntegerMod_int, privkey: IntegerMod_int, msg: str) -> Tuple[IntegerMod_int, IntegerMod_int]:
        print("Signing with fixed nonce")
        ...
        s = (1/nonce) * (h_2 + 1337*privkey*r)

        #print("Signature tried: ", (r, s))

        
        return r, s

    def Sign(self, privkey, msg) -> Tuple[IntegerMod_int, IntegerMod_int]:
        print("Signing normally")
        ...
        #generate a random number between 1 and q-1
        nonce = 0
        r,s = 0,0 
        while nonce == 0:
    ...
    def Verify(self, pubkey: Point, msg: str, r: IntegerMod_int, s: IntegerMod_int) -> bool:
        ...
        if int(r) < 1 | self.q < int(r) | int(s) < 1 | self.q < int(s):
            print("Error: r or s is not in the correct range")
            return False
